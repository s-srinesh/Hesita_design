    ...
    <div className="footer">
      <div className="f-info">
          ...
          <div className="f-logo-text">
            <Link style={{ display: "flex" }} to="/">
              ...
              <div className="f-text">
                <p><h6>Hestia Design Studio</h6></p>
              </div>
            </Link>
          </div>
        ...
        <section className="f-contact">
          <p>Contact</p>
          <p>1/1/30 Pillaiyar kovil street Erode </p>
          <p>
            <a href="mailto: contact@interno.com">contact@HestiaDesignStudio.com</a>
          </p>
          <p>+91 9345783603</p>
        </section>
      </div>
      ...
      <div className="f-copyright">
        <p>Copyright © Hestia Design Studio | Designed by Jafarli</p>
      </div>
    </div>
  );
}
